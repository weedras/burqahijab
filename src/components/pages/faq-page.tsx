  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        answer:
          'Yes, we offer free shipping on all domestic orders within Pakistan that exceed PKR 3,000 in value. For orders below this amount, a flat shipping fee of PKR 200 applies. For international orders, shipping rates vary by destination and are calculated at checkout. We frequently run promotional campaigns that include free shipping offers, so be sure to subscribe to our newsletter and follow us on social media to stay updated on our latest deals and shipping promotions.',
      },
      {
        question: 'How can I track my order?',
        answer:
          'Once your order has been dispatched from our warehouse, you will receive an email and SMS notification containing your tracking number and a link to track your shipment. You can enter this tracking number on the courier company\'s website or use their mobile app for real-time updates. If you experience any issues with tracking or have not received your tracking information within 48 hours of placing your order, please contact our customer service team at hello@burqahijab.shop or WhatsApp us at +92 300 1234567 for immediate assistance.',
      },
      {
